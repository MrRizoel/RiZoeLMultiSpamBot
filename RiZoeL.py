...
async def start_rizoel():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
            await idk(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            await idk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            await ydk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            await wdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            await hdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            await sdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
            await adk(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            await adk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            await bdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
            await cdk(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            await cdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
            await edk(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            await edk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@RiZoeLX"))
