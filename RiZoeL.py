...
@idk.on(events.NewMessage(pattern="^Ok", incoming=True))
@ydk.on(events.NewMessage(pattern="^Ok", incoming=True))
@wdk.on(events.NewMessage(pattern="^Ok", incoming=True))
@hdk.on(events.NewMessage(pattern="^Ok", incoming=True))
@sdk.on(events.NewMessage(pattern="^Ok", incoming=True))
@adk.on(events.NewMessage(pattern="^Ok", incoming=True))
@bdk.on(events.NewMessage(pattern="^Ok", incoming=True))
@cdk.on(events.NewMessage(pattern="^Ok", incoming=True))
@edk.on(events.NewMessage(pattern="^Ok", incoming=True))
@hdk.on(events.NewMessage(pattern="^Ok", incoming=True))
@ddk.on(events.NewMessage(pattern="^Ok", incoming=True))
@vkk.on(events.NewMessage(pattern="^Ok", incoming=True))
@kkk.on(events.NewMessage(pattern="^Ok", incoming=True))
@lkk.on(events.NewMessage(pattern="^Ok", incoming=True))
@mkk.on(events.NewMessage(pattern="^Ok", incoming=True))
@sid.on(events.NewMessage(pattern="^Ok", incoming=True))
@shy.on(events.NewMessage(pattern="^Ok", incoming=True))
@aan.on(events.NewMessage(pattern="^Ok", incoming=True))
@ake.on(events.NewMessage(pattern="^Ok", incoming=True))
@eel.on(events.NewMessage(pattern="^Ok", incoming=True))
@khu.on(events.NewMessage(pattern="^Ok", incoming=True))
@shi.on(events.NewMessage(pattern="^Ok", incoming=True))
@yaa.on(events.NewMessage(pattern="^Ok", incoming=True))
@dav.on(events.NewMessage(pattern="^Ok", incoming=True))
@raj.on(events.NewMessage(pattern="^Ok", incoming=True))
@put.on(events.NewMessage(pattern="^Ok", incoming=True))

async def hhe(event)class="":
    try:
