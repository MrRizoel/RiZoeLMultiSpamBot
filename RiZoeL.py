...
async def start_rizoel():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if smexxx:
        ...
        try:
            ...
            await wdk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await ann(functions.channels.JoinChannelRequest(channel="@Romantic_Vibe"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
