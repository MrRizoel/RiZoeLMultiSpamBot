...
async def start_rizoel():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_GIVEAWAYZ"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_GIVEAWAYZ"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_GIVEAWAYZ"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_GIVEAWAYZ"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_GIVEAWAYZ"))
